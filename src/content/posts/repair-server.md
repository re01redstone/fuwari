...
# Long Long After
然后就是经过了又一周给寄过去了, 直接就发现这内存咋是intel专用条, 俩人买的时候都不知道有专用条这种东西, 所以各位也注意一下.(当然这个也不是主要原因, 毕竟在之前主板上还是可以点亮的)

然后用店里面的硬件做最小系统测试, 发现显卡完全没有问题, 问题在于, CPU的pcie通道坏了, 导致CPU不认显卡. 所以说这件事告诉了我们一个什么道理呢? 对了, 就是亮VGA不一定是显卡问题.
